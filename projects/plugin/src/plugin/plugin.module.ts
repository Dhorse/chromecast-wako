...
const components = [MovieButtonComponent, EpisodeButtonComponent, SettingsComponent, MediaModalComponent, PluginDetailComponent, RateButtonComponent, RatePopoverComponent];
